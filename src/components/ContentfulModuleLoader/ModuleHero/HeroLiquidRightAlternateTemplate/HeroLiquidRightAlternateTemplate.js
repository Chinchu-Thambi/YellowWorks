...
const HeroLiquidRightAlternateTemplate = ({
  reference,
  title: rawTitle,
  backgroundColor,
  ...
  return (
    <Background color={backgroundColor}>
      <Container
        ...
        minHeight={image && image.file && (getProportionalHeight({
          targetWidth: 640,
...
HeroLiquidRightAlternateTemplate.defaultProps = {
  reference: '',
  title: {
    title: '',
  },
...
HeroLiquidRightAlternateTemplate.propTypes = {
...
export default withTheme(HeroLiquidRightAlternateTemplate);
