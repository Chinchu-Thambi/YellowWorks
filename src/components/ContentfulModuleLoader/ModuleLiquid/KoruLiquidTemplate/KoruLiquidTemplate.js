...
import {
  Background, Container, Content, Description,
} from './Styled';

const KoruLiquidTemplate = ({
  reference,
  title: rawTitle,
  ...
  return (
    <Background color={backgroundColor}>
      <Container
        ...
        minHeight={image && getProportionalHeight({
          targetWidth: 640,
...
KoruLiquidTemplate.defaultProps = {
  reference: '',
  title: {
    title: '',
  },
...
export default withTheme(KoruLiquidTemplate);
