...
const SectionTextRightTemplate = ({
  reference,
  title: rawTitle,
...
SectionTextRightTemplate.defaultProps = {
  reference: '',
  title: {
    title: '',
  },
...
SectionTextRightTemplate.propTypes = {
...
export default withTheme(SectionTextRightTemplate);
