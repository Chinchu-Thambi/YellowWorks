...
const CardSquareLongFormTemplate = ({
  title: rawTitle,
...
CardSquareLongFormTemplate.defaultProps = {
  title: {
    title: '',
  },
  subtitle: {
...
CardSquareLongFormTemplate.propTypes = {
...
export default withTheme(CardSquareLongFormTemplate);
