...
const CardFourSquareVariationTemplate = ({
  title: rawTitle,
...
CardFourSquareVariationTemplate.defaultProps = {
  title: {
    title: '',
  },
  subtitle: {
...
CardFourSquareVariationTemplate.propTypes = {
...
export default withTheme(CardFourSquareVariationTemplate);
