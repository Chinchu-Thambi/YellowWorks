...
import { SelectBoxContainer, SelectBox, RemoveButton } from '../../OpeningHours.styled';
import crossIcon from '../../../../../../../assets/icons/black-delete-cross.svg';
...
const SelectorRow = (props) => {
  ...
  const handleDelete = () => {
    props.onDelete(openingHoursEntry);
  };
  return (
    <Flex>
