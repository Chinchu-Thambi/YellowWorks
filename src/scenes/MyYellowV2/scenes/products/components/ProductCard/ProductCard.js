...
import Card from '../../../../../MyYellow/components/Card';
          ...
          <Box flex="1">
              ...
              <>
                {subscription?.orderDetails?.status !== 'NEW' && (
                  <>
                    ...
                    <Box mr={2} mb={2} display="inline-block">
                      <Button
                        to={`/myyellowv2/my-products/yellow-profile/manage-profile/${subscription.id}`}
                        variant="tertiary"
                        size="sm"
                        outline="true"
                      >Manage Profile
                    ...
                    <Box mr={2} mb={2} display="inline-block">
                      <Button
                        to={`/myyellowv2/my-products/yellow-profile/manage-plan/${subscription.id}`}
                        variant="tertiary"
                        size="sm"
                        outline="true"
                      >Manage Plan
            ...
            {(isYol || isGmb) && (subscription?.orderDetails?.status === 'NEW') && (
              <>
                ...
                <Button
                  to={`/myyellowv2/onboarding/yellow-profile/${subscription.id}`}
                  variant="tertiary"
                  size="sm"
                  outline="true"
                >Set up
