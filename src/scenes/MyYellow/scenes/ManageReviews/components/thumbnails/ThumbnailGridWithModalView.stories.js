...
import ThumbnailGridWithModalView from './ThumbnailGridWithModalView';

export const ThumbnailsGridWithModalView = () => {
  const images = [
  ...
  return <ThumbnailGridWithModalView images={R.take(count, images)} thumbnailSize={75} />;
};
