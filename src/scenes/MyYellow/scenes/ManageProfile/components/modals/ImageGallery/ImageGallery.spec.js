...
describe('<ImageGallery>', () => {
  ...
  it('test file upload', async () => {
    ...
    const fileContent = '(⌐□_□)';
    const fileName = 'chucknorris.jpeg';
  ...
  //   expect(wrapper.find('[data-testId="UploadButtonsContainer"] button').first().text()).toBe('ADD IMAGES');
  //   expect(wrapper.find('[data-testId="UploadButtonsContainer"] button').last().text()).toBe('ADD A VIDEO');
  // });
});
